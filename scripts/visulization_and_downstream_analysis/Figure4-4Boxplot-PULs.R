...
# 8.2 Ensure required columns exist for calculation (add NA columns if missing to prevent mutate errors)
...
col_fill_ratio  <- c("WT" = "#1A1A1A",  # sky blue
                     "DB" = "#E69F00")  # bluish green
col_point_ratio <- c("WT" = "#1A1A1A",  # deeper blue
                     "DB" = "#E69F00")  # deeper green
...
# 8.8 Plotting PULs ratios - Gut (Cecum/Colon/Rectum; equal height for significance brackets)
for (r in all_ratios) {
