...
process_sample() {
    ...
    echo "outdir=/public/home/wangycgroup/xinlong/mouse_colon/04.MGBC/${sample}" >> config.ini
    ...
    echo "krakenDb=/public/home/wangycgroup/public/Database/Microbiome/kraken2_MGBC" >> config.ini
...
process_mapping() {
    local sample=$1
    cd /public/home/wangycgroup/xinlong/mouse_colon/04.MGBC/
    ...
    /public/home/wangycgroup/public/software/bin/python /public/home/wangycgroup/xinlong/mouse_colon/02.M1/build.py \
        /public/home/wangycgroup/public/00_Genome_ref/genomesForPipeline/MGBC/genomes/genome_map.tsv \
        ${sample}/species.txt ${sample}/acc.txt \
        /public/home/wangycgroup/public/00_Genome_ref/genomesForPipeline/MGBC/genomes \
...
for sample in "${samples[@]}"; do
    ...
    /public/home/wangycgroup/public/software/pigz-2.7/pigz -p 8 /public/home/wangycgroup/xinlong/mouse_colon/04.MGBC/${sample}/${sample}_Solo.out/GeneFull/filtered/*
    /public/home/wangycgroup/public/software/pigz-2.7/pigz -p 8 /public/home/wangycgroup/xinlong/mouse_colon/04.MGBC/${sample}/${sample}_Solo.out/GeneFull/raw/*  
done
