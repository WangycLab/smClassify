# ======================================================
# Nitrogen Metabolism ModuleScore & Visualization
# Author: Ziye Xu
# Date: 2025-10-17
# ======================================================
...
p_dot
ggsave("plots/Dotplot_Amino acid metabolism by Group.pdf",
...
p_dot<-DotPlot(
  ...
  ggtitle("Amino acid metabolism")
p_dot
ggsave("plots/Dotplot_Amino acid metabolism by top20_species.pdf",
...
genes_bile <- c("cbh",#Directly deconjugates bile acids (including taurine/glycine conjugates of TDCA/TCDCA).
...
p_dot
ggsave("plots/Dotplot_Bile acid.pdf",
...
p_dot
ggsave("plots/Dotplot_Bile acid related genes_top20_species.pdf",
       p_dot, width = 12, height = 6)
ggsave("plots/Dotplot_Bile acid related genes_top20_species.png",
...
p_dot<-DotPlot(
  ...
  scale_x_discrete(limits = rev)  
p_dot
ggsave("plots/Dotplot_LFCA related genes.pdf",
       p_dot, width = 5.5, height = 4)
...
p_dot<-DotPlot(
  ...
  theme(plot.margin  = margin(t = 15, r = 15, b = 15, l = 15, unit = "mm"))
p_dot
ggsave("plots/Dotplot_LFCA related genes_top20_species.pdf",
       p_dot, width = 12, height = 6)
ggsave("plots/Dotplot_LFCA related genes_top20_species.png",
       p_dot, width = 12, height = 6, dpi = 300)
