# Bile acid metabolism - Per-metabolite boxplots (WT vs DB)
...
targets_raw <- c(
  "Taurocholic acid","Taurodeoxycholic acid","Taurochenodesoxycholic acid", # Taurine-conjugated BAs
  "Glutathione","Uric acid"                                                # Host metabolites
)

targets_lc <- tolower(targets_raw)
targets    <- targets_raw[match(unique(targets_lc), targets_lc)]

fname_prefix <- "Bile acid metabolism"

## ======================================================
## 1) Read data & convert to long format
##    (updated filenames, new Sample column style)
## ======================================================
...
##    Colon-DB1, Cecum-WT3, Rectum-DB5, Serum-WT2, ...
## ======================================================
...
## ======================================================
## 3) Select only target metabolites (case-insensitive)
## ======================================================
...
## ======================================================
## 4) Welch t-test (two-sided) + FDR per tissue
## ======================================================
...
## ======================================================
## 8) Plotting - Gut (Cecum / Colon / Rectum)
## ======================================================
